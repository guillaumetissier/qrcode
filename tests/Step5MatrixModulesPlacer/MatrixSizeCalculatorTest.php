...
{
    private MatrixSizeCalculator $matrixSizeCalculator;

    public function setUp(): void
    {
        $this->matrixSizeCalculator = new MatrixSizeCalculator();
    }

    /**
     * @dataProvider provideDataToTestCalculate
     */
    public function testCalculate(?Version $version, ?int $expectedSize): void
    {
        $this->assertEquals($expectedSize, $this->matrixSizeCalculator->setVersion($version)->calculate());
    }

    public static function provideDataToTestCalculate(): \Generator
    {
        yield [null, null];
