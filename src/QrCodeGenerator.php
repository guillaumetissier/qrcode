...
final class QrCodeGenerator
{
    ...
    {
        $this->logger?->notice('*** Step 1. Encode data ***');
        ...
        $mode = $encoder->getMode();
        $version = $encoder->getVersion();

        $this->logger?->notice('*** Step 2. Building QR code matrix ***');
        ...
        $this->logger?->notice('*** Step 3. Rendering QR code matrix ***');
